            ...
            <Row className='align-items-center'>
                <Col md={6}>
                    <div className='intro_left'>
                        ...
                        <div>
                            <button className='sign_up' onClick={() => navigate('/signup')}>Sign UP It's Free</button> <span className='or_span'> OR </span>
                            <button className='start_project' onClick={() => navigate('/dashboard/projects')}>Start a project!</button>
                        </div>
                    </div>
                </Col>
                <Col md={6}>
