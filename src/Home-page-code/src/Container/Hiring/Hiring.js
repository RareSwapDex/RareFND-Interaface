...
import HiringImg1 from '../../assets/images/hiring_img1.png';
import HiringImg2 from '../../assets/images/hiring_img2.png';
import HiringImg3 from '../../assets/images/hiring_img3.png';
import RightArrow from '../../assets/images/right_arrow.png';
import HireArrow from '../../assets/images/hiring_arrow.png';
import './Hiring.css';
                ...
                <Row>
                    ...
                    <Col md={12}>
                        <div className='text-center mt-3'>
                            <button className='work_together'>Work Better, Together</button>
                            <button className='hire_rare'>Hire a Rare Fund Expert</button>
                        </div>
                    </Col>
                </Row>
            </Container>
